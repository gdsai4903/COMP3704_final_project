...
class CycleGAN:
    ...
    def identity_loss(self, real_image, same_image, lambda_identity=10):
        '''
    ...
    def train_step(self, real_x, real_y):
        ...
        with tf.GradientTape(persistent=True) as tape:
            ...
            identity_loss_x = self.identity_loss(real_x, same_x, lambda_identity=10)
            identity_loss_y = self.identity_loss(real_y, same_y, lambda_identity=10)
            ...
            gen_g_loss = self.generator_loss(disc_fake_y) + identity_loss_y
            gen_f_loss = self.generator_loss(disc_fake_x) + identity_loss_x

            cycle_loss_g = self.cycle_consistency_loss(real_x, cycled_x, LAMBDA)
            cycle_loss_f = self.cycle_consistency_loss(real_y, cycled_y, LAMBDA)
    ...
    def load_weights(self, load_dir):
        ...
        self.generator_g.load_weights(os.path.join(load_dir, 'generator_g.weights.h5'))
        self.generator_f.load_weights(os.path.join(load_dir, 'generator_f.weights.h5'))
        self.discriminator_x.load_weights(os.path.join(load_dir, 'discriminator_x.weights.h5'))
        self.discriminator_y.load_weights(os.path.join(load_dir, 'discriminator_y.weights.h5'))
    ...
    def save_weights(self, save_dir):
        ...
        self.generator_g.save_weights(os.path.join(save_dir, 'generator_g.weights.h5'))
        self.generator_f.save_weights(os.path.join(save_dir, 'generator_f.weights.h5'))
        self.discriminator_x.save_weights(os.path.join(save_dir, 'discriminator_x.weights.h5'))
        self.discriminator_y.save_weights(os.path.join(save_dir, 'discriminator_y.weights.h5'))
